...
df_weibo = pd.read_csv('Senti_Keyword_total.csv', sep=',', encoding='gb18030')
df_weibo = df_weibo.drop(['微博url', '工具', '微博内容', '情感得分', 'TF-IDF关键词', 'TextRank关键词'], axis=1)
